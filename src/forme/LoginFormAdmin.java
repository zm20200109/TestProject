...
public class LoginFormAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("mika@gmail.com");

        jPasswordField1.setText("mika1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Admin a = Controller.getInstance().loginAdmin(username, passwd);
        
        if(a!=null){
            this.dispose();
            ServerWorkingForm swf = new ServerWorkingForm();
            swf.setVisible(true);
        }else{
